...
#ifndef DEMOAPPFORTESTS_SWIFT_H
#define DEMOAPPFORTESTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DemoAppForTests",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15DemoAppForTests11AppDelegate")
...
SWIFT_CLASS("_TtC15DemoAppForTests10CoffeeCell")
...
SWIFT_CLASS("_TtC15DemoAppForTests25CoffeeOrderViewController")
@interface CoffeeOrderViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
@interface CoffeeOrderViewController (SWIFT_EXTENSION(DemoAppForTests)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC15DemoAppForTests13SceneDelegate")
...
SWIFT_CLASS("_TtC15DemoAppForTests14ViewController")
